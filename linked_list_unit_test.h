...
#ifndef STRUCTUREEXPRUNITTEST_LINKED_LIST_UNIT_TEST_H
#define STRUCTUREEXPRUNITTEST_LINKED_LIST_UNIT_TEST_H
 ...
 * @Return Success or Failure
 */
extern int ListTraverse(LkList * l, int (* visit) (int e));
...
#endif //STRUCTUREEXPRUNITTEST_LINKED_LIST_UNIT_TEST_H
